...
namespace Booking.Business
{
    public class AutenticacionBusiness
    {
        public Miembro IniciarSesion(string dni, string contrasena)
        {
            ...
            var miembrosServiceRemoteAddress = new System.ServiceModel.EndpointAddress("http://localhost:25703/MiembrosService.svc");            var miembrosServiceRemoteAddress = new System.ServiceModel.EndpointAddress("http://localhost:82/MiembrosService.svc");
